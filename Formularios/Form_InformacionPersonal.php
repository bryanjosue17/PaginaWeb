...
VALUES(?,?,?,?,?,?,?,?,?,?,STR_TO_DATE(?,'%m/%d/%Y'),?,?)";
    ...
    $stm->execute(array($relacion,$_POST['expediente'], $_POST['documento'], $_POST['nombre1'], $_POST['nombre2'], $_POST['nombre3'], $_POST['apellido1'], $_POST['apellido2'], $_POST['casado'], $_POST['sueldo'], $_POST['fechanac'] ,$_POST['direccion'],$_POST['telefono']));
    ...
    if(  $sueldo<3000) {
        ...
        header("Location: Form_DigitalizacionIndividual.php");
    }
    else{
...
<html>	
<head>
<title>Formulario Personas Involucradas</title>
...
<body>
<h1>Informacion de Personas Involucradas</h1>
