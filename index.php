        ...
        <div  class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item mx-0 mx-lg-1">
                  <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="Formularios/Form_Expedientes.php">Creacion de Proyecto</a>
              </li>
              <li class="nav-item mx-0 mx-lg-1">
                  <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="Crud/tabla.php">Modificacion y Eliminacion de Usuarios</a>
              </li>
              <li class="nav-item mx-0 mx-lg-1">
                  <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="Formularios/Form_Usuarios.php"> Creacion de Usuarios</a>
              </li>
          </ul>
            <?php
